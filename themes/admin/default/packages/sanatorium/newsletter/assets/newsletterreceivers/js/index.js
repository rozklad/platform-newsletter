...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'newsletterreceiver');

		$('.daterangepicker_end_input').attr('data-grid', 'newsletterreceiver');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('newsletterreceiver', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
